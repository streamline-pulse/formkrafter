...
| `remote` | une URL, avec interpolation `{key}` et recherche côté serveur optionnelle |
...
Tout autre caractère est un littéral et s'insère automatiquement — `+229 99 99 99 99`
s'écrit `+229 99 99 99 99`.
