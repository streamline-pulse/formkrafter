---
title: Packages
description: The four npm packages, their entry points, what each one exports, and which ones you actually need to install.
---

import { Aside, Tabs, TabItem, CardGrid, LinkCard } from '@astrojs/starlight/components'

All four packages are published under the `@streamline-pulse` scope with
